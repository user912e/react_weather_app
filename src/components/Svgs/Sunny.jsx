    ...
    <>
      ...
      >
        <g>
          <polygon
            fill="#F29D00"
            points="58.482,31.412 62.019,24.903 65.557,31.412 	"
          />
          <polygon
            fill="#F29D00"
            points="64.649,31.076 70.41,26.712 71.087,34.194 	"
          />
          <polygon
            fill="#F29D00"
            points="69.963,33.518 77.031,33.158 73.791,39.838 	"
          />
          <polygon
            fill="#F29D00"
            points="73.271,38.434 79.847,41.21 74.295,45.87 	"
          />
          <polygon
            fill="#F29D00"
            points="74.57,44.201 79.2,49.884 72.251,51.302 	"
          />
          <polygon
            fill="#F29D00"
            points="50.915,47.469 44.768,43.746 50.878,39.955 	"
          />
          <polygon
            fill="#F29D00"
            points="54.198,52.643 47.122,52.663 50.644,46.145 	"
          />
          <polygon
            fill="#F29D00"
            points="50.667,40.435 47.499,33.715 54.563,34.161 	"
          />
          <polygon
            fill="#F29D00"
            points="53.338,34.769 53.183,27.256 59.386,30.87 	"
          />
          <polygon
            fill="#F29D00"
            points="64.228,55.462 60.651,61.322 57.661,55.102 	"
          />
          <polygon
            fill="#F29D00"
            points="58.717,54.975 53.173,58.732 52.882,51.755 	"
          />
          <polygon
            fill="#F29D00"
            points="69.29,53.504 68.494,60.436 63.24,56.237 	"
          />

          <polygon
            fill="#F29D00"
            points="72.809,49.879 74.637,56.587 68.253,54.914 	"
          />
          <path
            fill="#F1C600"
            d="M74.509,43.258c0,7.083-5.407,12.825-12.075,12.825c-6.669,0-12.075-5.742-12.075-12.825
		c0-4.879,2.566-9.122,6.343-11.29c1.705-0.979,3.658-1.535,5.732-1.535C69.103,30.433,74.509,36.175,74.509,43.258z"
          />
          <g>
            <path
              fill="#217EBA"
              d="M53.162,44.172c-1.461,0-2.837,0.362-4.045,0.999c-1.653-3.708-5.649-6.326-10.318-6.326
            ...
            <path
              fill="#217EBA"
              d="M78.54,52.895c-1.121-0.026-2.183,0.228-3.119,0.696c-1.211-2.875-4.236-4.953-7.819-5.034
            ...
            <g>
              <motion.path
                ...
                fill="#3B96D2"
                d="M50.901,65.109c0.086-4.224,3.611-7.57,7.876-7.473c0.717,0.016,1.41,0.132,2.066,0.328
              ...
              <path
                fill="#3B96D2"
                d="M63.386,71.322c-0.082,0.063-0.166,0.125-0.251,0.185c0.156,0.196,0.322,0.385,0.496,0.567
				C63.538,71.828,63.454,71.577,63.386,71.322z"
              />
            </g>
            <path
              fill="#3B96D2"
              d="M15.713,61.01c0-5.506,4.505-9.97,10.062-9.97c0.936,0,1.84,0.13,2.7,0.366
